...
namespace Functions
{
    public class Function
    {
        ...
        public static double FunctionOne(double x, double y) //Manyminima_5
        {
            ...
            double c1 = (1 + Math.Pow(x - 1.21, 4)) / 10000000 + Math.Pow(y + 5.312, 4) / 10000000 - 1 / (1 + Math.Pow(x - 1.21, 2)) - 1 / (1 + Math.Pow(y + 5.812, 2));
            double c2 = -1 / (1 + Math.Sqrt(5 * Math.Pow(x + 2, 2) + 6 * Math.Pow(y + 8, 2)));
